...
// Debug endpoint to check connected users
// Removed unauthenticated /debug-connected-users — it disclosed the live map of logged-in
// user_id → socket_id (session enumeration / socket-hijack recon). (SECURITY_FOLLOWUPS #15)
...
//   }
// });
// Removed unauthenticated /test-alert — returned patient+clinician+admin names/emails/phones
// for any patient_id AND sent real Twilio SMS + inserted a real alert row. (SECURITY_FOLLOWUPS #15)
// New endpoint to check socket connections
// Removed unauthenticated /connection-status — duplicate disclosure of the online-user /
// socket map (same class as /debug-connected-users). (SECURITY_FOLLOWUPS #15)
...
// Removed unauthenticated /test/bp-alert — forged BP alerts for any patient_id, pushed
// PHI over sockets, returned assigned-doctor IDs. (SECURITY_FOLLOWUPS #15)
